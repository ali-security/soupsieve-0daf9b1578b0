...
class TestHas(util.TestCase):
    ...
    def test_has_excessive_empty(self):
        """Test that `:has()` rejects an excessive run of empty slots instead of expanding it."""

        self.assert_raises('div:has({})'.format(',' * 10000), SelectorSyntaxError)
